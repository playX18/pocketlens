...
class ProtocolModelsTest {
    private val json = PocketLensJson.instance
    ...
    fun receiverStatusFixturesMatchDto() {
        ...
        assertEquals("PocketLens Linux", ready.receiverName)
        assertEquals(1, ready.protocolVersion)
        assertEquals("_pocketlens._udp.local", ready.serviceType)
    ...
    fun pairFixturesMatchDto() {
        ...
        assertEquals("PocketLens Linux", response.receiverName)
