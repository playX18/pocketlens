...
import com.acamera.android.control.ReceiverEventStream
...
import com.acamera.android.protocol.AudioConfig
...
import com.acamera.android.protocol.ReceiverCapabilities
...
import com.acamera.android.protocol.VideoConfig
import com.acamera.android.protocol.VirtualDevice
import com.acamera.android.protocol.VirtualDevices
import com.acamera.android.state.CameraFacing
import com.acamera.android.state.SessionStatus
import com.acamera.android.storage.InMemoryTokenStorage
...
class ACameraControllerTest {
    ...
    fun discoverySelectionPairAndSessionStartWireControlClientToMediaSession() = runBlocking {
        ...
        val controller = ACameraController(
    ...
    private class FakeControlClient : ControlClient {
        ...
        override suspend fun status(baseUrl: String): ReceiverStatus {
            ...
            return ReceiverStatus(
                receiverName = "Desk",
                protocolVersion = 1,
                serviceType = "_acamera._udp.local",
                paired = false,
                activeSession = false,
                ...
                virtualDevices = VirtualDevices(
                    camera = VirtualDevice("ACamera", true, "v4l2loopback"),
                    microphone = VirtualDevice("ACamera Microphone", true, "pipewire"),
                ),
            )
        }
        ...
        override suspend fun securePairingResult(baseUrl: String, pairingId: String): SecurePairResultResponse {
            ...
            val encrypted = ACameraCrypto.encryptToHex(
                key,
                pairingId.encodeToByteArray(),
                com.acamera.android.protocol.ACameraJson.instance.encodeToString(
