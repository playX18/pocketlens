...
import com.pocketlens.android.protocol.PocketLensJson
import com.pocketlens.android.protocol.ErrorEnvelope
...
class HttpJsonControlClient(
    private val json: Json = PocketLensJson.instance,
